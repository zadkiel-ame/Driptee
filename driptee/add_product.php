...
<body class="auth-page"> <div class="auth-container"> <a href="admin_dashboard.php" class="back-link">← Back</a>
        ...
        <form action="add_product.php" method="POST" enctype="multipart/form-data">
            <div class="input-group">
                ...
                <input type="text" name="brand" placeholder="e.g. Mervin Silverio" required>
            </div>
