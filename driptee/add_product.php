...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($check !== false) {
        if (move_uploaded_file($_FILES["product_image"]["tmp_name"], $target_file)) {
            ...
            $stmt->bind_param("sdsss", $brand, $price, $category, $target_file, $status);
...
<body class="auth-page">
    <div class="auth-container"> 
        <a href="admin_dashboard.php" class="back-link" style="text-decoration:none; color:#000; font-weight:bold;">← Back</a>
        ...
        <form action="add_product.php" method="POST" enctype="multipart/form-data">
            <div class="input-group">
                ...
                <input type="text" name="brand" placeholder="e.g. Gucci" required>
            </div>

            <div class="input-group">
                <label>Category</label>
                <select name="category"
                    style="width: 100%; padding: 12px; border: 1.5px solid #1a1a1a; border-radius: 8px;">
            ...
            <div class="input-group">
                <label>Price (₱)</label>
                <input type="number" name="price" placeholder="100.00" required>
            </div>
